...
namespace TippyToe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Gender,Price,Style")] Shoes shoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Gender,Price,Style")] Shoes shoes)
        {
            if (id != shoes.Id)
            {
                return NotFound();
