...
namespace TippyToe.Controllers
{
    public class SizesController : Controller
    {
        ...
        public SizesController(TippyToeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SizeNumber")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SizeNumber")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
